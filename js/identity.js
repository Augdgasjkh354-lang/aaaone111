...
export const IDENTITIES = ["无籍少年", "在籍平民", "行贩", "摊主", "铺主", "书院学子", "应试士子", "得解士子", "衙门书吏", "进士(待阙)"];
...
export function getIdentityContext(player) {
  ...
  const notes = {
    ...
    "行贩": "挑担逐客流谋生，算良贱之间最辛苦的市井营生，官街占道要看街司脸色。",
    "摊主": "有了固定摊位与字号，在市井中开始有头脸，但仍要受地面、街司与行规约束。",
    "铺主": "在清河坊或御街有铺面有租契，是市井中有头脸的人物；但在士人与官面眼里仍是商贾，门第天花板换了一层，没有消失。",
...
export function getIdentitySystemPromptRule() {
  return "身份决定门第观感：无籍者在体面场所近乎不可见；在籍平民可被按良民对待；行贩挑担谋生，客人看商誉与手艺，官街占道会怕街司；摊主有固定摊位和字号，名声开始成为公共信息；铺主是市井中有头脸的人物，但在士人与官面眼里仍是商贾，门第天花板换了一层，没有消失；书院学子有寒素士人门面；应试士子有考试资格；得解士子在临安是有分量的体面人，门第观感大变；曾得解者亦受士林敬重；衙门书吏虽小却是官面上的人；进士(待阙)为本作最高门第观感，但不得生成官职内容。NPC对得解及以上身份的借贷信用应上调。不得由AI擅自改变身份，身份变迁只由代码条件判定。";
}
